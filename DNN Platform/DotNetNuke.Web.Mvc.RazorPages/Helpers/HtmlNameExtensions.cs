...
{
    /// <summary>
    /// Gets the HTML ID and name attributes of the <see cref="T:DotNetNuke.Web.Mvc.RazorPages.HtmlHelper"/> string.
    /// </summary>
    public static class HtmlNameExtensions
    {
        /// <summary>
        /// Gets the ID of the <see cref="T:DotNetNuke.Web.Mvc.RazorPages.HtmlHelper"/> string.
        /// </summary>
        /// 
        /// <returns>
